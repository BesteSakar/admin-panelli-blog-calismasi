    ...
    public class BlogController : Controller
    {
        ...
        public async Task<IActionResult> Save(Blog model)
        {
            if (model != null)
            {
                ...
                //C:\Users\beste\Desktop\KisiselBlog\KisiselBlog\wwwroot\assets\img\
                string savePath = Path.Combine("C:","Users", "beste", "Desktop", "KisiselBlog", "KisiselBlog", "wwwroot", "assets", "img");

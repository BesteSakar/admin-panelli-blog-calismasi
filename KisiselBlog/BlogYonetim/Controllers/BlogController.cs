    ...
    public class BlogController : Controller
    {
        ...
        public async Task<IActionResult> Save(Blog model)
        {
            if (model != null)
            {
                ...
                //C:\Users\mehme\Desktop\salı\gonderılen\Yeni klasör\KisiselBlog\KisiselBlog\wwwroot\assets\img
                string savePath = Path.Combine("C:", "Users", "mehme", "Desktop", "salı", "gonderılen", "Yeni klasör", "KisiselBlog", "KisiselBlog", "wwwroot", "assets", "img");
